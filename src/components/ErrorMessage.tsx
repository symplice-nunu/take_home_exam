  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <button
        ...
        className="rounded-lg bg-danger px-5 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-danger/90 focus:outline-none focus:ring-2 focus:ring-danger focus:ring-offset-2"
      >
        Try Again
      </button>
    </div>
