...
export default function SortToggle({ sort, onToggle }: Props) {
  return (
    <button
      ...
      className="inline-flex w-full items-center justify-between gap-3 rounded-xl bg-white px-4 py-3.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:w-auto sm:min-w-[180px] sm:justify-center"
    >
